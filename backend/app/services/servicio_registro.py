...
class RegistroService:
        ...
        data = [
            {
                ...
                'Placa': servicio.vehiculo.vehi_placa if servicio.vehiculo else None,
                'Trailer': servicio.trailer.trai_placa if servicio.trailer else None,
    ...
    def calcular_ingresos(self):
        ...
        return {
            ...
            "productos": {
                nombre: {"peso_neto_producto": f"{peso / 1000:,.3f}"}
    ...
    def calcular_despachos(self):
        ...
        return {
            "total_peso_neto": f"{total_peso_neto / 1000:,.3f}",
            "destinos": {
                nombre: {"peso_neto_destino": f"{peso / 1000:,.3f}"}
    ...
    def crear_registro(self, registro_data: RegistroCreate, usuario_id: int):
        ...
        nuevo_historial = Historial(
            ...
            his_idregistro=nuevo_registro.reg_id
        )
    ...
    def actualizar_registro(self, reg_id: int, registro_data: RegistroUpdate, usuario_id: int):
        ...
        estado_anterior = registro_db.reg_estado
        ...
        accion = "FINALIZADO" if estado_anterior == 0 and registro_db.reg_estado == 1 else "ACTUALIZADO"
